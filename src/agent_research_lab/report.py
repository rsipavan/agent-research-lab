...
def _footer_md() -> str:
    return (
        "---\n\n"
        "_Generated by [agent-research-lab](https://github.com/) — the video is characterized first, "
        "then any checkable claims are validated against market data via the TradingView MCP. Verdicts "
        "are computed from the data, not LLM-judged. See the trace for the step-by-step._\n"
    )
